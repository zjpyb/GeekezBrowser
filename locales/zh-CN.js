...
window.zhCN = {
    ...
    settingsTabXray: "🚀 Xray 核心",
    settingsXrayTitle: "Xray 核心管理",
    settingsXrayDesc: "管理 Xray 核心版本。切换不同版本以实现兼容性或测试需求。",
    xrayCurrentVersion: "当前版本",
    xrayVersion: "版本: ",
    xrayLastUpdate: "最后更新: ",
    xraySwitchTitle: "🔄 切换版本",
    xraySwitchDesc: "选择要切换的版本。更改将在下次启动环境时生效。",
    xraySelectVersion: "选择版本...",
    xraySwitchBtn: "切换版本",
    xrayAvailableTitle: "📦 可用版本",
    xrayAvailableDesc: "显示本地版本和 GitHub 最新 10 个发布版本",
    xrayRefreshBtn: "🔄 刷新",
    xrayLoadingVersions: "加载版本中...",
    xrayNoVersions: "暂无可用版本",
    xrayInstalledVersions: "📥 已安装",
    xrayGithubVersions: "☁️ GitHub 可用版本 (最新 10 个)",
    xrayInstalled: "已安装",
    xrayLoadError: "加载版本失败",
    xrayCurrent: "当前",
    xraySelect: "选择",
    xrayDownloadTitle: "⬇️ 下载新版本",
    xrayDownloadDesc: "输入特定版本标签或使用 'latest' 下载最新版本。",
    xrayDownloadBtn: "下载",
    xrayInfoTitle: "重要提示",
    xrayInfo1: "版本更改需要重启正在运行的环境",
    xrayInfo2: "已下载的版本存储在本地，可随时切换",
    xrayInfo3: "查看 Xray 发布页面以获取可用版本",
    xraySelectVersionFirst: "请先选择一个版本",
    xraySwitchSuccess: "成功切换版本。请重启正在运行的环境。",
    xraySwitchFailed: "切换版本失败",
    xraySwitchError: "切换 Xray 版本时出错",
    xrayEnterVersion: "请输入版本号",
    xrayDownloading: "下载中...",
    xrayDownloadSuccess: "下载成功",
    xrayDownloadFailed: "下载失败",
    xrayDownloadError: "下载 Xray 版本时出错"
};
